...
function required()
{
    ...
    if ($CI->router->fetch_class() == 'site' && $CI->router->fetch_method() == 'index') {
        ...
        $common = array('payu', 'status', 'macro', 'auth', 'pservice', 'frontend', 'settings', 'import', 'home', 'profile', 'request', 'api', 'cronjobs', 'logs', 'doctorvisit', 'site', 'category', 'roadmap', 'board','feedback', 'faq', 'blog', 'gallery', 'featured','gridsection', 'review','crutches');
